...
export function ProjectList({ onOpen, user, onLogout }: Props) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0e0e0e', color: '#e5e5e5', userSelect: 'none' }}>
      ...
      >
        <span style={{ fontSize: 13, color: '#8a8a8a', maxWidth: 120, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
          {user.username}
        </span>
        {user.role === 'admin' && (
          <button
